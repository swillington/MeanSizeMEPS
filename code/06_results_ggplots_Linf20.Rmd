...
```{r alfonsino baseline linf20 change in mean data}
## baseline change in mean 
alfonsino_plotdata20 <- alfonsino_alldatafull %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==38.816|Linf==48.52)

alfonsino_plotdata20$data.ID <- factor(alfonsino_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL alfonsino baseline linf20 change in mean}
#M/k plot
alfonsino_baselineplot <- ggplot(data = alfonsino_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  ...
  scale_shape_manual(values = c(3, 19), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
...
ggsave("alfonsino_change_mean_baseline_linf20_fulldist.png",
...
#mortality plot
alfonsino_baselineplot_M <- ggplot(data = alfonsino_plotdata20, aes(x = M, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("alfonsino_change_mean_baseline_linf20_M_fulldist.png",
       plot = alfonsino_baselineplot_M, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")

alfonsino_baselineplot_K <- ggplot(data = alfonsino_plotdata20, aes(x = K, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("alfonsino_change_mean_baseline_linf20_K_fulldist.png",
...
ggsave("alfonsino_change_mean_baseline_linf20_MKpanel_fulldist.png",
       plot = panel, 
       path = plot_path, 
...
```{r alfonsino baseline linf20 truncated 25 change in mean data}
## baseline change in mean 
alfonsino25_plotdata20 <- alfonsino_alldata25 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==38.816|Linf==48.52)

alfonsino25_plotdata20$data.ID <- factor(alfonsino25_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL alfonsino baseline linf20 truncated 25 change in mean}
#M/k plot
alfonsino_baselineplot_truncated25 <- ggplot(data = alfonsino25_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.34, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
...
ggsave("alfonsino_change_mean_baseline_linf20_25dist.png",
       plot = alfonsino_baselineplot_truncated25, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r alfonsino baseline linf20 truncated 66 change in mean data}
## baseline change in mean 
alfonsino66_plotdata20 <- alfonsino_alldata66 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==38.816|Linf==48.52)

alfonsino66_plotdata20$data.ID <- factor(alfonsino66_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)


```

```{r 1 PANEL alfonsino baseline linf20 truncated 66 change in mean}
#M/k plot
alfonsino_baselineplot_truncated66 <- ggplot(data = alfonsino66_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.34, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
  ...
  theme(panel.grid.major = element_blank(),  
    ...
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_alfonsino, aes(x = standardised.M.K, y= -33),width = 1, inherit.aes = FALSE) + 
...
ggsave("alfonsino_change_mean_baseline_linf20_66dist.png",
       plot = alfonsino_baselineplot_truncated66, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r alfonsino baseline linf20 truncated facet}
alfonsino_truncated_facet_data <- rbind(alfonsino_plotdata20, alfonsino25_plotdata20, alfonsino66_plotdata20)
...
alfonsino_truncated_facet_plot <- ggplot(data = alfonsino_truncated_facet_data, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  ...
  scale_shape_manual(values = c(3, 19), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
  scale_color_continuous_diverging(palette = "blue-red", l1=30, l2=80, p1=0.1, p2=0.8)+
  scale_y_continuous(limits = c(-70, 65), breaks = seq(-60, 60, by=20)) +
...
ggsave("alfonsino_change_mean_baseline_linf20_alfonsino_truncated_facet.png",
...
```{r alfonsino baseline linf20 truncated comparison}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )

truncated_comp <- rbind(alfonsino_plotdata20, alfonsino25_plotdata20, alfonsino66_plotdata20)
...
alfonsino_truncated_compare <- ggplot(data = truncated_comp, aes(x = Mk.ratio, y = change.mean.percent, colour = run.name)) +
  ...
  facet_wrap(.~data.ID)+
  scale_y_continuous(limits = c(-80, 63), breaks = seq(-70, 70, by=20)) +
  theme(strip.text = element_text(size = 10, face = "bold", vjust = 0.8), 
    panel.grid.major = element_blank(),  
    panel.grid.minor = element_blank(),
    strip.background = element_blank(),
   ...
   legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_alfonsino, aes(x = standardised.M.K, y= -75),width = 3, inherit.aes = FALSE) + 
  geom_rug(data = mk_alfonsino, aes(x = standardised.M.K, y = -43), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
...
ggsave("alfonsino_change_mean_baseline_linf20_truncated_comparison.png",
...
```{r 1 PANEL alfonsino baseline linf20 change in mean increasing k}
## baseline change in mean 
alfonsino_plotdata20k <- alfonsino_alldatak %>% 
  filter(scenario!="baseline" ) %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==38.816|Linf==48.52)

alfonsino_plotdata20k$data.ID <- factor(alfonsino_plotdata20k$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

alfonsino_baselineplotk <- ggplot(data = alfonsino_plotdata20k, aes(x = K, y = change.mean.percent, size=Mk.ratio, colour = data.ID)) +
  geom_vline(xintercept = 0.2190, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  ...
  scale_colour_manual(values = c("#CC79A7", "#56B4E9"), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
  scale_y_continuous(limits = c(-25, 42), breaks = seq(-20, 40, by=10)) +
  ...
  theme( panel.grid.major = element_blank(),  
    ...
    legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_alfonsino, aes(x = standardised.K, y= -23.5),width = 2, inherit.aes = FALSE) + 
  geom_rug(data = mk_alfonsino, aes(x = standardised.K, y = -23.5), sides = "b", inherit.aes = FALSE, linewidth=0.5)

alfonsino_baselineplotk

plot_path <- file.path(paste(project_dir, "03_results","main_plots", sep = "/"))

ggsave("alfonsino_change_mean_baselinek_Linfk20.png",
       plot = alfonsino_baselineplotk, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r alfonsino baseline linf20 change in mean truncated increasing k}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )
truncatedk_comp <- rbind(alfonsino_alldatak, alfonsino_alldata25k, alfonsino_alldata66k)

truncatedk_comp20 <- truncatedk_comp %>%
  filter(scenario!="baseline") %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==38.816|Linf==48.52) %>% 
  mutate(run.name = case_when(
...
truncatedk_comp20$run.name <- factor(truncatedk_comp20$run.name, levels = c("Full distribution", "Truncated 25%","Truncated 66%"), ordered = TRUE)

truncatedk_comp20$data.ID <- factor(truncatedk_comp20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)()

alfonsinok_truncated_compare <- ggplot(data = truncatedk_comp20, aes(x = K, y = change.mean.percent, colour = run.name, shape = data.ID)) +
  geom_vline(xintercept = 0.2190, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point(size = 1) +
  ...
  scale_shape_manual(values = c(3, 19), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
  scale_color_manual(values = cbPalette)+
  scale_y_continuous(limits = c(-25, 41), breaks = seq(-20, 45, by=10)) +
  scale_x_continuous(limits = c(0.12, 0.45)) +
  theme(strip.text.x = element_text(size = 8, face = "bold", vjust = 0.8), 
    ...
    legend.title = element_text(size=12), 
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_alfonsino, aes(x = standardised.K, y= -23.5),width = 1.5, inherit.aes = FALSE) + 
  geom_rug(data = mk_alfonsino, aes(x = standardised.K, y = -23.5), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
...
ggsave("alfonsino_change_mean_baselinek_Linfk20_truncated_comparison.png",
...
```{r swordfish baseline linf20 change in mean data}
## baseline change in mean 
swordfish_plotdata20 <- swordfish_alldatafull %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==	146.528|Linf==183.16)

swordfish_plotdata20$data.ID <- factor(swordfish_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL swordfish baseline linf20 change in mean}
#M/k plot
swordfish_baselineplot <- ggplot(data = swordfish_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
...
#save plot 
plot_path <- file.path(paste(project_dir,"03_results", "main_plots", sep = "/"))
ggsave("swordfish_change_mean_baseline_linf20_fulldist.png",
       plot = swordfish_baselineplot, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")

#mortality plot
swordfish_baselineplot_M <- ggplot(data = swordfish_plotdata20, aes(x = M, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("swordfish_change_mean_baseline_linf20_M_fulldist.png",
       plot = swordfish_baselineplot_M, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")

swordfish_baselineplot_K <- ggplot(data = swordfish_plotdata20, aes(x = K, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("swordfish_change_mean_baseline_linf20_K_fulldist.png",
...
ggsave("swordfish_change_mean_baseline_linf20_MKpanel_fulldist.png",
       plot = panel, 
       path = plot_path, 
       width = 30, height = 14, units = "cm")
...
```{r swordfish baseline linf20 truncated 25 change in mean data}
## baseline change in mean 
swordfish25_plotdata20 <- swordfish_alldata25 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==146.528|Linf==183.16)

swordfish25_plotdata20$data.ID <- factor(swordfish25_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL swordfish baseline linf20 truncated 25 change in mean}
#M/k plot
swordfish_baselineplot_truncated25 <- ggplot(data = swordfish25_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.1251, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
  ...
  scale_shape_manual(values = c(3, 19), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
  scale_color_continuous_diverging(palette = "blue-red", l1=30, l2=80, p1=0.1, p2=0.8)+
  scale_y_continuous(breaks = seq(-50, 60, by=10)) +
  theme(panel.grid.major = element_blank(),  
    panel.grid.minor = element_blank(), 
    axis.title = element_text(size=13),
    axis.title.x = element_text(vjust = -0.2), 
    ...
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_swordfish, aes(x = standardised.M.K, y= -48),width = 1.5, inherit.aes = FALSE) + 
  geom_rug(data = mk_swordfish, aes(x = standardised.M.K, y = -43), sides = "b", inherit.aes = FALSE, linewidth=0.5)
swordfish_baselineplot_truncated25

plot_path <- file.path(paste(project_dir, "03_results", "main_plots",sep = "/"))

ggsave("swordfish_change_mean_baseline_linf20_25dist.png",
       plot = swordfish_baselineplot_truncated25, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r swordfish baseline linf20 truncated 66 change in mean data}
## baseline change in mean 
swordfish66_plotdata20 <- swordfish_alldata66 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==146.528|Linf==183.16)

swordfish66_plotdata20$data.ID <- factor(swordfish66_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL swordfish baseline linf20 truncated 66 change in mean}
#M/k plot
swordfish_baselineplot_truncated66 <- ggplot(data = swordfish66_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.1251, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
  ...
  theme(panel.grid.major = element_blank(),  
    ...
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_swordfish, aes(x = standardised.M.K, y= -35),width = 0.8, inherit.aes = FALSE) + 
  geom_rug(data = mk_swordfish, aes(x = standardised.M.K, y = -35), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
swordfish_baselineplot_truncated66

plot_path <- file.path(paste(project_dir, "03_results", "main_plots", sep = "/"))

ggsave("swordfish_change_mean_baseline_linf20_66dist.png",
...
```{r swordfish baseline linf20 truncated facet}
swordfish_truncated_facet_data <- rbind(swordfish_plotdata20, swordfish25_plotdata20, swordfish66_plotdata20)
...
swordfish_truncated_facet_plot <- ggplot(data = swordfish_truncated_facet_data, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  ...
  scale_color_continuous_diverging(palette = "blue-red", l1=30, l2=80, p1=0.1, p2=0.8)+
  scale_y_continuous(limits = c(-70, 65), breaks = seq(-70, 60, by=20)) +
  theme(strip.text = element_text(size = 10, face = "bold", vjust = 0.8), 
        strip.background = element_blank(),
        panel.grid.major = element_blank(),  
        panel.grid.minor = element_blank(), 
        ...
        plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_swordfish, aes(x = standardised.M.K, y= -68),width = 3, inherit.aes = FALSE) + 
...
ggsave("swordfish_change_mean_baseline_linf20_swordfish_truncated_facet.png",
...
```{r swordfish baseline linf20 truncated comparison}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )

truncated_comp <- rbind(swordfish_plotdata20, swordfish25_plotdata20, swordfish66_plotdata20)
...
swordfish_truncated_compare <- ggplot(data = truncated_comp, aes(x = Mk.ratio, y = change.mean.percent, colour = run.name)) +
  ...
  theme(strip.text = element_text(size = 10, face = "bold", vjust = 0.8), 
   ...
   legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_swordfish, aes(x = standardised.M.K, y= -70),width = 2.5, inherit.aes = FALSE) + 
  geom_rug(data = mk_swordfish, aes(x = standardised.M.K, y = -43), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
...
ggsave("swordfish_change_mean_baseline_linf20_truncated_comparison.png",
...
```{r 1 PANEL swordfish baseline linf20 change in mean increasing k}
## baseline change in mean 
swordfish_plotdata20k <- swordfish_alldatak %>% 
  filter(scenario!="baseline" ) %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==146.528|Linf==183.16)

swordfish_plotdata20k$data.ID <- factor(swordfish_plotdata20k$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

swordfish_baselineplotk <- ggplot(data = swordfish_plotdata20k, aes(x = K, y = change.mean.percent, size = Mk.ratio, colour = data.ID)) +
  geom_vline(xintercept = 0.391, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  ...
  theme( panel.grid.major = element_blank(),  
    ...
    legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_swordfish, aes(x = standardised.K, y= -25),width = 1.5, inherit.aes = FALSE) + 
...
ggsave("swordfish_change_mean_baselinek_Linfk20.png",
       plot = swordfish_baselineplotk, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r swordfish baseline linf20 change in mean truncated increasing k}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )
...
swordfishk_truncated_compare <- ggplot(data = truncatedk_comp20, aes(x = K, y = change.mean.percent, colour = run.name, shape = data.ID)) +
  geom_vline(xintercept = 0.391, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point(size = 1) +
  labs(x = "Growth (K)", y = expression("% change mean length from initial scenario"), colour = expression("Size distribution"), shape="Scenario") +
...
ggsave("swordfish_change_mean_baselinek_Linfk20_truncated_comparison.png",
...
```{r moonwrasse baseline linf20 change in mean data}
## baseline change in mean 
moonwrasse_plotdata20 <- moonwrasse_alldatafull %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==	11.28|Linf==14.1)

moonwrasse_plotdata20$data.ID <- factor(moonwrasse_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL moonwrasse baseline linf20 change in mean}
#M/k plot
moonwrasse_baselineplot <- ggplot(data = moonwrasse_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
...
#save plot 
plot_path <- file.path(paste(project_dir, "03_results", "main_plots", sep = "/"))
ggsave("moonwrasse_change_mean_baseline_linf20_fulldist.png",
...
moonwrasse_baselineplot_M <- ggplot(data = moonwrasse_plotdata20, aes(x = M, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("moonwrasse_change_mean_baseline_linf20_M_fulldist.png",
       plot = moonwrasse_baselineplot_M, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")

moonwrasse_baselineplot_K <- ggplot(data = moonwrasse_plotdata20, aes(x = K, y = change.mean.percent, colour = change.max.percent, shape = data.ID)) +
...
ggsave("moonwrasse_change_mean_baseline_linf20_K_fulldist.png",
...
ggsave("moonwrasse_change_mean_baseline_linf20_MKpanel_fulldist.png",
       plot = panel, 
       path = plot_path, 
       width = 30, height = 14, units = "cm")
...
```{r moonwrasse baseline linf20 truncated 25 change in mean data}
## baseline change in mean 
moonwrasse25_plotdata20 <- moonwrasse_alldata25 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==	11.28|Linf==14.1)

moonwrasse25_plotdata20$data.ID <- factor(moonwrasse25_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL moonwrasse baseline linf20 truncated 25 change in mean}
#M/k plot
moonwrasse_baselineplot_truncated25 <- ggplot(data = moonwrasse25_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.345, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
  ...
  theme(panel.grid.major = element_blank(),  
    ...
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.M.K, y= -47),width = 2, inherit.aes = FALSE) + 
...
ggsave("moonwrasse_change_mean_baseline_linf20_25dist.png",
       plot = moonwrasse_baselineplot_truncated25, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r moonwrasse baseline linf20 truncated 66 change in mean data}
## baseline change in mean 
moonwrasse66_plotdata20 <- moonwrasse_alldata66 %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==	11.28|Linf==14.1)

moonwrasse66_plotdata20$data.ID <- factor(moonwrasse66_plotdata20$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

```

```{r 1 PANEL moonwrasse baseline linf20 truncated 66 change in mean}
#M/k plot
moonwrasse_baselineplot_truncated66 <- ggplot(data = moonwrasse66_plotdata20, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  geom_vline(xintercept = 1.345, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "M/K (mortality/growth) ratio", y = expression("% change in mean length from initial scenario"), colour = expression("% change in \nmaximum length \nfrom initial scenario"), shape = "Scenario") +
  ...
  theme(panel.grid.major = element_blank(),  
    ...
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.M.K, y= -36),width = 1, inherit.aes = FALSE) + 
...
ggsave("moonwrasse_change_mean_baseline_linf20_66dist.png",
...
```{r moonwrasse baseline linf20 truncated facet}
moonwrasse_truncated_facet_data <- rbind(moonwrasse_plotdata20, moonwrasse25_plotdata20, moonwrasse66_plotdata20)
...
moonwrasse_truncated_facet_plot <- ggplot(data = moonwrasse_truncated_facet_data, aes(x = Mk.ratio, y = change.mean.percent, colour = change.max.percent, shape= data.ID)) +
  ...
  scale_shape_manual(values = c(3, 19), 
                     labels = c("baseline"=expression("No change in L"[inf]), 
                                "Linf"=expression("20% decline in L"[inf])))+
  scale_color_continuous_diverging(palette = "blue-red", l1=30, l2=80, p1=0.1, p2=0.8)+
  scale_y_continuous(limits = c(-70, 55), breaks = seq(-70, 60, by=20)) +
  theme(strip.text = element_text(size = 10, face = "bold", vjust = 0.8), 
        strip.background = element_blank(),
        panel.grid.major = element_blank(),  
        panel.grid.minor = element_blank(), 
        ...
        plot.margin = margin(t=25, r=25, l=25, b=25))+
  guides(color = guide_colorbar(barheight = 10))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.M.K, y= -68),width = 3, inherit.aes = FALSE) + 
  geom_rug(data = mk_moonwrasse, aes(x = standardised.M.K, y = -22), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
moonwrasse_truncated_facet_plot

plot_path <- file.path(paste(project_dir, "03_results", "main_plots", sep = "/"))

ggsave("moonwrasse_change_mean_baseline_linf20_moonwrasse_truncated_facet.png",
...
```{r moonwrasse baseline linf20 truncated comparison}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )

truncated_comp <- rbind(moonwrasse_plotdata20, moonwrasse25_plotdata20, moonwrasse66_plotdata20)
...
moonwrasse_truncated_compare <- ggplot(data = truncated_comp, aes(x = Mk.ratio, y = change.mean.percent, colour = run.name)) +
  ...
  facet_wrap(.~data.ID)+
  rotate_x_facet_text(align = 0.5, angle = 0)+
  scale_y_continuous(limits = c(-75, 55), breaks = seq(-70, 60, by=20)) +
  theme(strip.text = element_text(size = 10, face = "bold", vjust = 0.8), 
    panel.grid.major = element_blank(),  
    panel.grid.minor = element_blank(),
    strip.background = element_blank(),
   ...
   legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.M.K, y= -70),width = 2.5, inherit.aes = FALSE) + 
  geom_rug(data = mk_moonwrasse, aes(x = standardised.M.K, y = -43), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
...
ggsave("moonwrasse_change_mean_baseline_linf20_truncated_comparison.png",
...
```{r 1 PANEL moonwrasse baseline linf20 change in mean increasing k}
## baseline change in mean 
moonwrasse_plotdata20k <- moonwrasse_alldatak %>% 
  filter(scenario!="baseline" ) %>% 
  filter(data.ID=="baseline"|data.ID=="Linf") %>% 
  filter(Linf==	11.28|Linf==14.1)

moonwrasse_plotdata20k$data.ID <- factor(moonwrasse_plotdata20k$data.ID , levels = c("baseline", "Linf"), ordered = TRUE)

moonwrasse_baselineplotk <- ggplot(data = moonwrasse_plotdata20k, aes(x = K, y = change.mean.percent, size = Mk.ratio, colour = data.ID)) +
  geom_vline(xintercept = 0.540, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point() +
  labs(x = "Growth (K)", y = expression("% change in mean length from initial scenario"), size = expression("M/K ratio"), colour="Scenario") +
  ...
  theme( panel.grid.major = element_blank(),  
    ...
    legend.margin = margin(b= 20),
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.K, y= -25),width = 1, inherit.aes = FALSE) + 
  geom_rug(data = mk_moonwrasse, aes(x = standardised.K, y = -15), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
moonwrasse_baselineplotk

plot_path <- file.path(paste(project_dir, "03_results", "main_plots",sep = "/"))

ggsave("moonwrasse_change_mean_baselinek_Linfk20.png",
       plot = moonwrasse_baselineplotk, 
       path = plot_path, 
       width = 20, height = 15, units = "cm")
```

```{r moonwrasse baseline linf20 change in mean truncated increasing k}
cbPalette <- c("#CC79A7", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00","#000000" )
...
moonwrassek_truncated_compare <- ggplot(data = truncatedk_comp20, aes(x = K, y = change.mean.percent, colour = run.name, shape = data.ID)) +
  geom_vline(xintercept = 0.540, linetype = "dotted", linewidth=0.5) +
  geom_hline(yintercept = 0, linetype = "dashed", linewidth=0.5) +
  geom_point(size = 1) +
  labs(x = "Growth (K)", y = expression("% change mean length from initial scenario"), colour = expression("Size distribution"), shape="Scenario") +
  ...
  theme(panel.grid.major = element_blank(),  
    ...
    legend.title = element_text(size=12), 
    plot.margin = margin(t=25, r=25, l=25, b=25))+
  geom_boxplot(data = mk_moonwrasse, aes(x = standardised.K, y= -30),width = 2, inherit.aes = FALSE) + 
  geom_rug(data = mk_moonwrasse, aes(x = standardised.K, y = -15), sides = "b", inherit.aes = FALSE, linewidth=0.5) 
...
ggsave("moonwrasse_change_mean_baselinek_Linfk20_truncated_comparison.png",
